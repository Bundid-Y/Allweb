    ...
    <div class="content-section layout_padding">
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            ...
            <section id="dev-section1" style="margin-bottom: 40px;">
                <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
                    <div style="flex: 1; min-width: 300px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">ให้บริการขนส่งครอบคลุมทุกภูมิภาคและนิคมอุตสาหกรรมสำคัญทั่วประเทศ วางแผนเส้นทางอย่างมีประสิทธิภาพเพื่อให้การจัดส่งเป็นไปตามกำหนดเวลา รองรับทั้งงานขนส่งประจำและงานเร่งด่วนได้อย่างยืดหยุ่น</p>
                    </div>
                    <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
                        ...
                        <div class="image-wrapper" style="position: relative; width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box;">
                            ...
                            <img src="../img/other/service/transportation/industrial_route.jpeg" alt="In-house Engineering Image" style="display: block; width: 100%; position: relative; z-index: 2; box-shadow: 0px 15px 35px rgba(0, 0, 0, 0.2);">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="dev-section2" style="margin-bottom: 40px;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center; flex-direction: row-reverse;">
                    <div style="flex: 1; min-width: 300px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">ดำเนินงานภายใต้มาตรฐานด้านความปลอดภัยและคุณภาพในทุกขั้นตอน ตั้งแต่การรับสินค้า การจัดเก็บ ไปจนถึงการจัดส่งปลายทาง พร้อมระบบติดตามและตรวจสอบสถานะแบบต่อเนื่อง เพื่อลดความเสี่ยงและสร้างความมั่นใจสูงสุด</p>
                    </div>
                    <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
                        <!-- ช่องเปลี่ยนภาพ (นำลิงก์รูปมาใส่ใน src ด้านล่าง) -->
                        <div class="image-wrapper" style="position: relative; width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box;">
                            ...
                            <img src="../img/other/service/transportation/cameracontrol.jpeg" alt="Digital System & Innovation Image" style="display: block; width: 100%; position: relative; z-index: 2; box-shadow: 0px 15px 35px rgba(0, 0, 0, 0.2);">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="dev-section3" style="margin-bottom: 0px;">
                <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
                    <div style="flex: 1; min-width: 300px;">
                        <h3 style="font-size: 28px; color: #325662; margin-bottom: 15px;">รองรับการขนส่งชิ้นส่วนยานยนต์ที่มีความละเอียดอ่อน</h3>
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">มีความพร้อมในการดูแลและขนส่งชิ้นส่วนที่ต้องการความระมัดระวังเป็นพิเศษ ด้วยอุปกรณ์เฉพาะทางและขั้นตอนการจัดการที่ได้มาตรฐาน ป้องกันความเสียหายระหว่างการขนส่ง และรักษาคุณภาพของสินค้าให้ครบถ้วนสมบูรณ์จนถึงปลายทาง</p>
                    </div>
                    <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
                        <!-- ช่องเปลี่ยนภาพ (นำลิงก์รูปมาใส่ใน src ด้านล่าง) -->
                        <div class="image-wrapper" style="position: relative; width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box;">
                            <div style="position: absolute; top: -5%; right: -5%; width: 85%; height: 110%; background-color: #E82433; clip-path: polygon(100% 0, 15% 5%, 15% 95%, 100% 100%); z-index: 1;"></div>
                            <img src="../img/other/service/transportation/transport_parts.jpeg" alt="Advanced Tools Image" style="display: block; width: 100%; position: relative; z-index: 2; box-shadow: 0px 15px 35px rgba(0, 0, 0, 0.2);">
                        </div>
                    </div>
                </div>
            </section>
