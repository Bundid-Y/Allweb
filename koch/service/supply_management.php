            ...
            <section id="dev-section1" style="margin-bottom: 40px;">
                <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
                    <div style="flex: 1; min-width: 300px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">ติดตามการหมุนเวียนของบรรจุภัณฑ์แบบใช้ซ้ำได้อย่างเป็นระบบ ตั้งแต่การจ่ายออก การใช้งาน จนถึงการส่งคืน ช่วยลดการสูญหาย เพิ่มความโปร่งใส และควบคุมต้นทุนได้อย่างมีประสิทธิภาพ</p>
                    </div>
                    <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
                        ...
                        <div class="image-wrapper" style="position: relative; width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box;">
                            ...
                            <img src="../img/other/service/supply/tracking.jpeg" alt="In-house Engineering Image" style="display: block; width: 100%; position: relative; z-index: 2; box-shadow: 0px 15px 35px rgba(0, 0, 0, 0.2);">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="dev-section2" style="margin-bottom: 40px;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center; flex-direction: row-reverse;">
                    <div style="flex: 1; min-width: 300px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">ควบคุมปริมาณบรรจุภัณฑ์คงคลังให้เหมาะสมกับปริมาณงานจริง ตรวจสอบสถานะคงเหลือแบบเรียลไทม์ ลดปัญหาขาดแคลนหรือสต็อกเกินความจำเป็น</p>
                    </div>
                    <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
                        <!-- ช่องเปลี่ยนภาพ (นำลิงก์รูปมาใส่ใน src ด้านล่าง) -->
                        <div class="image-wrapper" style="position: relative; width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box;">
                            ...
                            <img src="../img/other/service/supply/inventory.jpeg" alt="Digital System & Innovation Image" style="display: block; width: 100%; position: relative; z-index: 2; box-shadow: 0px 15px 35px rgba(0, 0, 0, 0.2);">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="dev-section3" style="margin-bottom: 0px;">
                <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
                    <div style="flex: 1; min-width: 300px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">นำข้อมูลการใช้งานมาวิเคราะห์แนวโน้มและประสิทธิภาพ เพื่อวางแผนการจัดสรรบรรจุภัณฑ์ให้สอดคล้องกับปริมาณงาน ช่วยเพิ่มความแม่นยำในการตัดสินใจและลดต้นทุนในระยะยาว</p>
                    </div>
                    <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
                        <!-- ช่องเปลี่ยนภาพ (นำลิงก์รูปมาใส่ใน src ด้านล่าง) -->
                        <div class="image-wrapper" style="position: relative; width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box;">
                            <div style="position: absolute; top: -5%; right: -5%; width: 85%; height: 110%; background-color: #E82433; clip-path: polygon(100% 0, 15% 5%, 15% 95%, 100% 100%); z-index: 1;"></div>
                            <img src="../img/other/service/supply/data_analytics.jpeg" alt="Advanced Tools Image" style="display: block; width: 100%; position: relative; z-index: 2; box-shadow: 0px 15px 35px rgba(0, 0, 0, 0.2);">
                        </div>
                    </div>
                </div>
            </section>
