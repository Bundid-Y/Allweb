...
<style>
    ...
    :root {
        ...
        --primary-dark: #c51d2a;
        --primary-glow: rgba(232, 36, 51, 0.15);
        --text-color: #2d3436;
        --text-muted: #636e72;
    ...
    .header .nav-link::after {
        ...
        left: 50%;
        transform: translateX(-50%);
        background: linear-gradient(90deg, var(--primary-color), #e82433);
    ...
    .header .btn-login {
        ...
        display: flex;
        align-items: center;
        background: linear-gradient(135deg, var(--primary-color) 0%, #e82433 100%);
        ...
        box-shadow: 0 4px 14px rgba(232, 36, 51, 0.25);
    ...
    .header .btn-login:hover {
        ...
        box-shadow: 0 8px 24px rgba(232, 36, 51, 0.35);
    }
    ...
    .header .dropdown-link:hover {
        background-color: rgba(232, 36, 51, 0.04);
        color: var(--primary-color);
        padding-left: 28px;
    }
    ...
    @media screen and (max-width: 1024px) {
        ...
        .nav-close:hover {
            background: rgba(232, 36, 51, 0.08);
            color: var(--primary-color);
        }
    }
</style>
