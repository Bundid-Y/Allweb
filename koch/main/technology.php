...
<style>
    ...
    .tech_section {
        ...
        padding-bottom: 45px;
        padding-top: 130px;
        /* Added to prevent overlap with menubar */
    }
    ...
    .tech_image {
        ...
        display: flex;
        justify-content: center;
        /* Center image instead of padding-left */
        align-items: center;
    }
    ...
    .tech_image img {
        ...
        /* added shadow to elevate the image */
    }
    ...
    .tech_subtitle:after {
        ...
        height: 3px;
        background-color: #e82433;
        /* Underline red color matches brand */
        left: 0px;
        bottom: -10px;
        /* Attach string below text relative */
        top: initial;
    }
