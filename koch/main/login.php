...
<body>
  ...
  <style>
    ...
    .login-page-wrapper {
      margin-top: 0;
      /* Removed margin to let background go to top */
      padding-top: 80px;
      /* Space for menubar content */
      width: 100%;
      flex: 1;
      display: flex;
      flex-direction: column;
    ...
    .login-container {
      ...
      overflow: hidden;
      min-height: 650px;
      /* Changed from 100vh to a fixed height to protect form layout */
    }
    ...
    .login-container:before {
      ...
      top: -50%;
      right: 48%;
      /* Adjusts the angle/position of the straight line */
      transform: translateY(-50%) rotate(15deg);
      /* Added rotation for the diagonal line */
      background-image: linear-gradient(-45deg, #e82433 0%, #325662 100%);
      transition: 1.8s ease-in-out;
      border-radius: 0;
      /* Changed from 50% to 0 for a straight edge */
      z-index: 6;
    }
