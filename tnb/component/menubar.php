                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item dropdown-item">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../service/domestic.php"
                                    class="dropdown-link">บริการขนส่งสินค้าในประเทศ</a></li>
                            <li><a href="../service/shuttle.php"
                                    class="dropdown-link">บริการรถรับ–ส่งระหว่างคลังสินค้า</a></li>
                            <li><a href="../service/import-export.php"
                                    class="dropdown-link">บริการขนส่งตู้คอนเทนเนอร์นำเข้า–ส่งออก</a></li>
                            <li><a href="../service/container.php"
                                    class="dropdown-link">บริการจัดการตู้คอนเทนเนอร์และลานตู้สินค้า</a></li>
                            <li><a href="../service/nationwide.php"
                                    class="dropdown-link">บริการกระจายสินค้าทั่วประเทศ</a></li>
                            <li><a href="../service/parking.php"
                                    class="dropdown-link">บริการที่จอดรถบรรทุกและบริหารพื้นที่จอด</a></li>        
                        </ul>
                    </li>
                    <!-- Dropdown 2 -->
                    <li class="nav-item dropdown-item">
                    ...
                    <li class="nav-item"><a href="../main/trucktypes.php" class="nav-link">ประเภทรถ</a></li>
